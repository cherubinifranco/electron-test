export const HomeIcon = (
  <svg
    className="w-5 h-5 mr-2 text-gray-400 group-hover:text-white"
    aria-hidden="true"
    fill="currentColor"
    viewBox="0 0 20 20"
  >
...
export const ReportIcon = (
  <svg
    ...
    viewBox="0 0 20 20"
  >
    <path d="M16 1h-3.278A1.992 1.992 0 0 0 11 0H7a1.993 1.993 0 0 0-1.722 1H2a2 2 0 0 0-2 2v15a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V3a2 2 0 0 0-2-2ZM7 2h4v2H7V2ZM5 15a1 1 0 1 1 0-2 1 1 0 0 1 0 2Zm0-4a1 1 0 1 1 0-2 1 1 0 0 1 0 2Zm8 4H8a1 1 0 0 1 0-2h5a1 1 0 0 1 0 2Zm0-4H8a1 1 0 0 1 0-2h5a1 1 0 1 1 0 2Z"></path>
  </svg>
);
...
export const FileIcon = (
  <svg
    className="mx-auto mt-1 w-6 h-7 text-gray-400"
    aria-hidden="true"
    fill="currentColor"
    viewBox="0 0 20 20"
  >
    <path d="M5 5V.13a2.96 2.96 0 0 0-1.293.749L.879 3.707A2.98 2.98 0 0 0 .13 5H5Z"></path>
    <path d="M14.066 0H7v5a2 2 0 0 1-2 2H0v11a1.97 1.97 0 0 0 1.934 2h12.132A1.97 1.97 0 0 0 16 18V2a1.97 1.97 0 0 0-1.934-2Z"></path>
  </svg>
);
...
export const FolderIcon = (
  <svg
    ...
    viewBox="0 0 20 20"
  >
    <path d="M4.09 7.586A1 1 0 0 1 5 7h13V6a2 2 0 0 0-2-2h-4.557L9.043.8a2.009 2.009 0 0 0-1.6-.8H2a2 2 0 0 0-2 2v14c.001.154.02.308.058.457L4.09 7.586Z"></path>
    <path d="M6.05 9 2 17.952c.14.031.281.047.424.048h12.95a.992.992 0 0 0 .909-.594L20 9H6.05Z"></path>
  </svg>
);
...
export const QuestionIcon = (
  ...
  >
    <path
      ...
      strokeLinejoin="round"
      strokeWidth="2"
      d="M9.5 10a2.5 2.5 0 1 1 5 .2 2.4 2.4 0 0 1-2.5 2.4V14m0 3h0m0 0Z"
    />
  </svg>
);
export const QuestionIcon2 = (
  <svg className="w-4 h-4" aria-hidden="true" fill="none" viewBox="6 6 13 13">
    <path
      stroke="currentColor"
      strokeLinecap="round"
      strokeLinejoin="round"
      strokeWidth="2"
      d="M9.5 10a2.5 2.5 0 1 1 5 .2 2.4 2.4 0 0 1-2.5 2.4V14m0 3h0m9 0Z"
    />
  </svg>
);

export const ResetIcon = (
  <svg className="w-4 h-4" aria-hidden="true" fill="none" viewBox="2 2 20 20">
    <path
      stroke="currentColor"
      strokeLinecap="round"
      strokeLinejoin="round"
